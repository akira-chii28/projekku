            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <a href="{{route('pengunjung.create')}}" class="btn btn-primary pull-right">Tambah </a>
                    </div>
                    <div class="card-body">
                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{++$i}}</td>
                                    <td>{{$row->Nama_peng}}</td>
                                    <td>{{$row->Alamat_peng}}</td>
                                    <td>{{$row->Kendaraan_peng}}</td>
                                    <td>{{$row->Plat_peng}}</td>
                                    <td>{{$row->Ket_peng}}</td>
                                    <td>{{$row->Jammasuk_peng}}</td>
                                    <td>{{$row->Jamkeluar_peng}}</td>
                                    <td><a href="{{route('pengunjung.edit',$row->id)}}" class="btn btn-success">Edit</a></td>
                                    <td><form action="{{route('pengunjung.destroy',$row->id)}}" method="POST">
                                        @csrf
                                        @method('DELETE')
