                        ...
                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$row->Kendaraan_pegawai}}</td>
                                    <td>{{$row->Plat_pegawai}}</td>
                                    <td>{{$row->Jammasuk_pegawai}}</td>
                                    <td>{{$row->Jamkeluar_pegawai}}</td>
                                    <td><a href="{{ route('generate',$row->id) }}" class="btn btn-primary">Generate</a></td>
                                    <td><a href="{{route('pegawai.edit',$row->id)}}" class="btn btn-success">Edit</a></td>
