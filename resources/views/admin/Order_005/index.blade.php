            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <a href="{{route('order_005.create')}}" class="btn btn-primary pull-right">Tambah </a>
                    </div>
                    <div class="card-body">
                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$row->Kendaraan_supir}}</td>
                                    <td>{{$row->Plat_supir}}</td>
                                    <td>{{$row->Jenis_barang}}</td>
                                    <td>{{$row->Jammasuk_supir}}</td>
                                    <td>{{$row->Jamkeluar_supir}}</td>
                                    <td><a href="{{route('order_005.edit',$row->id)}}" class="btn btn-success">Edit</a></td>
                                    <td><form action="{{route('order_005.destroy',$row->id)}}" method="POST">
                                        @csrf
                                        @method('DELETE')
